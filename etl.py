...
def process_song_file(cur, filepath):
    """
    Process song dataset to insert into the songs and artists dimensional tables
    """
...
def process_log_file(cur, filepath):
    """
    Process log dataset to insert into the time, users dimensional tables 
...
def process_data(cur, conn, filepath, func):
    """
    Process all the files in filepath and iterate 
    """
...
def main():
    """
    Establish connection with the sparkify database, gets
    cursor to it then close the connection
    """
